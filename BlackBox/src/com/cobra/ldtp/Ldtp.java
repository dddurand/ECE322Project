...
public class Ldtp {
     ...
     * @throws LdtpExecutionError on failure
     */
    public int doubleClickObject(String objName) throws LdtpExecutionError {
    	Object[] params = new Object[]{windowName, objName};
     ...
     * @throws LdtpExecutionError on failure
     */
    public int doubleClickRowText(String objName, String rowText) throws LdtpExecutionError {
	Object[] params = new Object[]{windowName, objName, rowText};
